...
class Product(models.Model):
    ...
    # store.Product.created_by: (fields.E301) Field defines a relation with the model 'auth.User', it has been added in the settings
    ...
    # when we click on the title i.e., django it will go the detail page
